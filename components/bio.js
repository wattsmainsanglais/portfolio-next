    ...
    return(
        <section className={styles.bio}>  
                <article className={styles.about}>
                    ...
                    I'm on Github under the username 'wattsmainsanglais'. Please find my tech stack listed below, this site has been developed in NextJS. Please contact me using the below contact form for any and all enquiries. </p>
