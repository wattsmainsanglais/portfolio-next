        ...
        <section className={styles.bio}>  
                ...
                <article className={styles.skills}>
                    ...
                    <aside className={styles.skillsLogo}>
                        <img  src="images/social_html5_html_71.png" aria-label="html logo" />
                        <img  src="images/css_3721.png" aria-label="css logo" />
                        <img src="images/javascript_logo_icon_145155.png" aria-label="Javascript logo" />
                        <img  src="images/expressjs_logo_icon_169185.png" aria-label="express js logo" />
                        <img  src="images/node_icon_196185.png" aria-label="node js logo" />
                    </aside>
                </article>
                    <hr />
        </section>
